...
import CreateUserModal from '@admin/components/users/CreateUserModal';
import EditUserModal from '@admin/components/users/EditUserModal';
import ViewUserPermissionsModal from '@admin/components/users/ViewUserPermissionsModal';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          <Button onClick={() => setIsCreateModalOpen(true)} className="flex bg-green-600 hover:bg-green-700">
