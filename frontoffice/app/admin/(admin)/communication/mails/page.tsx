...
import { getPagePreference, savePagePreference } from '@admin/lib/pagination-preferences';
import EmailTemplateDetailsModal from '@admin/components/communication/EmailTemplateDetailsModal';
import EditEmailTemplateModal from '@admin/components/communication/EditEmailTemplateModal';
...
const PAGE_NAME = 'communication-mails';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => router.push('/communication/mails/create')}
