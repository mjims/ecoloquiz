...
// Départements par région (exemple pour Île-de-France)
const DEPARTEMENTS: Record<string, string[]> = {
  ...
  // Ajoutez d'autres régions selon besoin
};
          ...
          {zoneType === 'TERRITOIRE' ? (
            ...
            <>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  DEV : tous points virgule séparent les différents codes postaux du champs libre
                </p>
              </div>
